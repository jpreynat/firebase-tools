...
const DownloadDetails = {
    ...
    firestore: {
        ...
        opts: {
            cacheDir: CACHE_DIR,
            remoteUrl: "https://storage.googleapis.com/firebase-preview-drop/emulator/cloud-firestore-emulator-v1.11.2.jar",
    ...
    gui: {
        ...
        opts: {
            cacheDir: CACHE_DIR,
            remoteUrl: "https://storage.googleapis.com/firebase-preview-drop/emulator/gui-vEAP.zip?_=" +
                new Date().getTime(),
            expectedSize: -1,
            expectedChecksum: "",
            namePrefix: "gui",
