...
function startAll(options, noGui = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (shouldStart(options, types_1.Emulators.LOGGING)) {
            const loggingAddr = constants_1.Constants.getAddress(types_1.Emulators.LOGGING, options);
            const loggingEmulator = new loggingEmulator_1.LoggingEmulator(Object.assign({ host: loggingAddr.host, port: loggingAddr.port }, options));
